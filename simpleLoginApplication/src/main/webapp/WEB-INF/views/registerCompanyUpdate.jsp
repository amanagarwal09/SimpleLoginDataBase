...
<body style="background-color: #eee">
	...
	<div class="container ">
		<form:form modelAttribute="registercompanyup" action="/regcompupdate"
			method="post">
			<div class="form-group ">
				...
				<form:input path="name" name="name" id="name" class="form-control"
					...
					cssErrorClass="form-control is-invalid" value="${name }"/>
			...
			<div class="form-group ">
				...
				<form:input path="companyname" name="companyname" id="companyname"
					...
					cssErrorClass="form-control is-invalid"  value="${companyname }"/>
			...
			<div class="form-group ">
				...
				<form:input path="contact" name="contact" id="contact"
					...
					cssErrorClass="form-control is-invalid"  value="${contact }"/>
			...
			<div class="form-group ">
				...
				<form:radiobutton path="gender" name="gender" id="gender"
					value="Male" checked="${gender=='Male' ? 'checked':''}"/>
				<form:label path="gender">Female</form:label>
				<form:radiobutton path="gender" name="gender" id="gender"
					value="Female" checked="${gender=='Female' ? 'checked':''}"/>
